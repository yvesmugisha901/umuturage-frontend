        ...
        <div className="features-container">
          <div className="feature-card">
            <div className="icon-wrapper">
              <img src="https://img.icons8.com/ios/100/ffffff/home-page.png" alt="Households" />
            </div>
          ...
          <div className="feature-card">
            <div className="icon-wrapper">
              <img src="https://img.icons8.com/ios/100/ffffff/combo-chart--v1.png" alt="Reports" />
            </div>
          ...
          <div className="feature-card">
            <div className="icon-wrapper">
              <img src="https://img.icons8.com/ios/100/ffffff/customer-support.png" alt="Support" />
            </div>
